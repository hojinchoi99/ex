                        ...
                        <div class='content-one'>
                            <TabPanel value="1">
                                <Carousel showIndicator={true} showThumbs={true} showStatus={false} autoPlay={true} showArrows={false} infiniteLoop={true}>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src= {require("./assets/img/slider1.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider2.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider3.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider4.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider5.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider6.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider7.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider8.png")} />
                                    </div>
                                    <div>
                                        <img style={{borderRadius: 20}} alt="" src={require("./assets/img/slider9.png")} />
                                    </div>
                                </Carousel>
